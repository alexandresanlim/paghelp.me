        ...
        public ICommand LoadData => new Command(() =>
        {
            try
            {
                GuideList = new ObservableCollection<Guide>
                {
                    ...
                    new Guide("O PIX é um meio de pagamento?",
                    ...
                    new Guide("Onde posso acessar o PIX?",
                    "O acesso ao Pix ocorre exclusivamente pelos canais de atendimento das instituições financeiras e de pagamento (celular, internet banking, agências, caixas eletrônicos) ou nos correspondentes bancários, como lotéricas, por exemplo. " +
                    "O Pix é um meio de pagamento disponibilizado por esses prestadores de serviço. Para evitar golpes, tenha a certeza de que está acessando um dos canais autorizados pelo seu banco ou instituição. \n\n" +
                    "Não acesse links de sites falsos."),

                    new Guide("O PIX já está em funcionamento?",
                    "Sim. O Pix está em funcionamento pleno desde 16 de novembro de 2020. \n\n" +
                    ...
                    new Guide("O PIX usa blockchain?",
                    ...
                    new Guide("Como eu posso ter acesso ao regulamento do PIX?",
                    "​​O Regulamento do Pix abrange a Resolução BCB Nº 1, de 2020, que disciplina seu funcionamento. \n\n" +
                    ...
                    new Guide("O que é uma chave PIX?",
                    ...
                    new Guide("O que é uma chave aleatória?",
                    ...
                    new Guide("Sou obrigado a cadastrar uma chave PIX para poder utilizar o PIX?",
                    ...
                    new Guide("Quantas chaves eu posso ter?",
                    "​Cada conta de pessoa física pode ter até 5 chaves vinculadas à ela, independentemente da quantidade de titulares. \n\n" +
                    ...
                    new Guide("Como efetuar os registros das minhas chaves no PIX?",
                    ...
                    new Guide("Se eu tenho mais de uma conta, posso incluir todas no PIX?",
                    "​Você poderá realizar o registro das suas chaves por meio de um dos canais de acesso da instituição em que você possui conta (inclusive aplicativo instalado em seu smartphone). \n\n" +
                    "Para realizar o registro, você precisará confirmar a posse da chave e vinculá-la a uma conta para recebimento dos recursos. Para confirmação da posse da chave, sua instituição enviará um código por SMS para o número de telefone celular que você quer utilizar como chave (ou para o e-mail que se quer utilizar como chave, se for o caso). \n\n" +
                    ...
                    new Guide("Posso vincular todas as chaves à mesma conta?",
                    "Sim. Você pode vincular todas as suas chaves (CPF, número de celular e e-mail) a uma mesma conta. \n\n" +
